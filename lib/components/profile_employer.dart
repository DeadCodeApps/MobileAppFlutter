...
class ProfileEmployer extends StatelessWidget {
  ...
  const ProfileEmployer({required this.employer});
  ...
  Widget buildContent() => Column(
        children: [
          ...
          Text(
            utf8.decode(employer.firstname.toString().runes.toList()),
            style: const TextStyle(fontSize: 28, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 8),
          Text(
            utf8.decode(employer.lastname.toString().runes.toList()),
  ...
  Widget buildAbout() => Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              utf8.decode(employer.companyName.toString().runes.toList()),
              style: const TextStyle(fontSize: 28, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 16),
            Text(
              utf8.decode(employer.description.toString().runes.toList()),
